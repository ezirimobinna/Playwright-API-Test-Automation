...
- Name: query_parameters.spec.js >> Verify that user can get query parameters
- Location: tests\query_parameters.spec.js:6:1
...
```ts
  ...
  2  | import requestBody from '../test-data/post_dynamic_request_body.json' with { type: 'json' };
  3  | import { stringFormat } from '../utils/common';
  4  | 
  5  | 
  6  | test('Verify that user can get query parameters', async ({ request }) => {
  7  | 
